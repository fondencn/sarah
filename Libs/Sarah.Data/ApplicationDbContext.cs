...
namespace Sarah.Data
{
    public class ApplicationDbContext : IdentityDbContext<User, Role, string>, IDBService
    {
        ...
        public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, IConfiguration? configuration, ILogger<ApplicationDbContext>? logger = null) : base(options)
        {
        ...
        public static IDBService CreateDefault(IConfiguration configuration)
        {
            ...
            Console.WriteLine("Using database at " + Path.GetFullPath(databaseFileName));
