...
namespace Sarah.LEDService
{
    ...
    {
        private readonly ILogger<ReSpeakerLEDService> _logger;

        public ReSpeakerLEDService(ILogger<ReSpeakerLEDService> logger)
        {
            _logger = logger;
        }
        ...
        private void Voltage_On()
        {
            ...
            _logger.LogDebug("Voltage_On(): GPIO {PowerPin} to {PinValue}", PowerPin, pinVal);
        }
        ...
        private void Voltage_Off()
        {
            ...
            _logger.LogDebug("Voltage_Off(): GPIO {PowerPin} to {PinValue}", PowerPin, pinVal);
        }
        ...
        public Task Booting()
        {
            return Task.Run(() =>
            {
                ...
                {
                    _logger.LogError(ex, "Booting: Fehler beim SPI Zugriff auf den LED Ring");
                }
            });
        }
        ...
        public Task FlashLight(bool isOn)
        {
            return Task.Run(() =>
            {
                ...
                {
                    _logger.LogError(ex, "FlashLight: Fehler beim SPI Zugriff auf den LED Ring");
                }
            });
        }
        ...
        public Task Listening()
        {
            return Task.Run(() =>
            {
                ...
                {
                    _logger.LogError(ex, "Listening: Fehler beim SPI Zugriff auf den LED Ring");
                }
            });
        }
        ...
        public Task Speaking()
        {
            return Task.Run(() =>
            {
                ...
                {
                    _logger.LogError(ex, "Speaking: Fehler beim SPI Zugriff auf den LED Ring");
                }
            });
        }
        ...
        public Task Thinking()
        {
            return Task.Run(() =>
            {
                ...
                {
                    _logger.LogError(ex, "Thinking: Fehler beim SPI Zugriff auf den LED Ring");
                }
            });
        }
