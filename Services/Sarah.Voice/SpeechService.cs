...
namespace Sarah.Voice
{
    ...
    public class SpeechService : ISpeechService
    {
        ...
        public SpeechService(ILEDService ledService, IDeviceServiceClient deviceServiceClient, IConfiguration configuration)
        {
        ...
        public void Initialize(string location, bool isRecognitionEnabled = true, bool isSynthesisEnabled = true)
        {
            ...
            {
                Intents.Initialize(this, this._DeviceServiceClient, this._LEDService);
                this.Recognizer = new AzureSpeechRecognizer(this._LEDService, this._Configuration);
            ...
            {
                this.Synthesizer = new AzureSpeechSynthesizer(this._LEDService, this._Configuration);
            ...
            Logger.Instance.LogInfo("SpeechService initialisiert. Standort: " + location + ", isRecognitionEnabled: " + isRecognitionEnabled + ", isSynthesisEnabled: " + isSynthesisEnabled);
        }
        ...
        public static void PlaySound(string sound)
        {
            ...
            {
                Logger.Instance.LogException("Cannot play sound file", ex);
            }
        }
        ...
        public void SayWithVolume(string text, SpeechVolume vol)
        {
            if (this.IsSynthesisEnabled)
            {
                if (this.IsSilent)
                {
                    Logger.Instance.LogWarning("Dieses Gerät ist gerade still bis " + this.EndOfSilentTime.Value.ToString());
                }
                else
                {
        ...
        public void StartListening()
        {
            ...
            {
                Logger.Instance.LogDebug("Fehler beim Start der Spracheingabe: " + ex.Message);
            }
        }
