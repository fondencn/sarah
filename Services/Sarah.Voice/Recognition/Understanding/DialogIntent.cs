...
namespace Sarah.Voice.Recognition.Understanding
{
    public class DialogIntent : Intent
    {
        ...
        public DialogIntent(SpeechService speechService, IDeviceServiceClient deviceServiceClient, string inputPattern, params string[] outputs) : base(speechService, deviceServiceClient)
        {
        ...
        public DialogIntent(SpeechService speechService, IDeviceServiceClient deviceServiceClient, string inputPattern, Func<string> outFunc) : base(speechService, deviceServiceClient)
        {
            this.InputPattern = inputPattern;
            this.Outputs = null;
