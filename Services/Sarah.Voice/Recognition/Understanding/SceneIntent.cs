...
namespace Sarah.Voice.Recognition.Understanding
{
    public class SceneIntent : Intent
    {
        ...
        public SceneIntent(ISpeechService speechService, IDeviceServiceClient deviceServiceClient) : base(speechService, deviceServiceClient)
        {
        ...
        protected override void HandleInternal(string recognizedSpeech)
        {
            ...
            {
                Logger.Instance.LogException("SceneIntent", ex);
                this.SayFail();
            }
        }
    }
