...
namespace Sarah.Voice.Recognition.Understanding
{
    public class SwitchControlIntent : Intent
    {
        ...
        public SwitchControlIntent(ISpeechService speechService, IDeviceServiceClient deviceServiceClient) : base(speechService, deviceServiceClient)
        {
        ...
        protected override async void HandleInternal(string recognizedSpeech)
        {
            ...
            {
                Logger.Instance.LogException("LightControlIntent", ex);
                this.SayFail();
            }
        }
    }
