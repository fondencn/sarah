...
namespace Sarah.Voice.Recognition.Understanding
{
    public class FlashlightIntent : Intent
    {
        ...
        public FlashlightIntent(SpeechService speechService, IDeviceServiceClient deviceServiceClient, ILEDService ledService) : base(speechService, deviceServiceClient)
        {
