...
namespace Sarah.Voice.Recognition.Understanding
{
    public class FindPersonIntent : Intent
    {
        ...
        public FindPersonIntent(ISpeechService speechService, IDeviceServiceClient deviceServiceClient) : base(speechService, deviceServiceClient)
        {
        ...
        protected override async void HandleInternal(string recognizedSpeech)
        {
            ...
            {
                Logger.Instance.LogException(nameof(FindPersonIntent), ex);
                this.SayFail();
            }
        }
