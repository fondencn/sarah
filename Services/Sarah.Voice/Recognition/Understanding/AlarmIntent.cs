...
namespace Sarah.Voice.Recognition.Understanding
{
    public class CreateAlarmIntent : Intent
    {
        ...
        public CreateAlarmIntent(ISpeechService speechService, IDeviceServiceClient deviceServiceClient) : base(speechService, deviceServiceClient)
        {
        ...
        protected override async void HandleInternal(string recognizedSpeech)
        {
            ...
            {
                Logger.Instance.LogException(nameof(CreateAlarmIntent), ex);
                this.SayFail();
            }
        }
