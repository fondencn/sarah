...
namespace Sarah.Voice.Recognition.Understanding
{
    public class WeatherIntent : Intent
    {
        ...
        public WeatherIntent(ISpeechService speechService, IDeviceServiceClient deviceServiceClient) : base(speechService, deviceServiceClient)
        {
        ...
        protected override async void HandleInternal(string recognizedSpeech)
        {
            ...
            {
                Logger.Instance.LogException("WeatherIntent", ex);
                this.SayFail();
            }
        }
    }
