...
namespace Sarah.Rules
{
    ...
    public class HardCodedRuleStore : IRuleStore
    {
        ...
        private void CreateRules()
        {
            ...
            //{
            //    Condition = new DoorSensorCondition(2) { Value  = DoorSensorState.Offen },
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetBrightness(255);
            //        await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetColor("#FF0000");
            //    }),
            //    Name = "Tür auf -> Licht rot"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new DoorSensorCondition(2) { Value = DoorSensorState.Geschlossen },
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetColor("#FFFFFF");
            //    }),
            //    Name = "Tür zu -> Licht weiß"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(6,30)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetLevel(99);
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetTemperature(22.0f);
            //    }),
            //    Name = "Jeden Tag um 6:30 -> Heizung 15 auf 22°C stellen"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(7, 0)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetLevel(99);
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetTemperature(14.0f);
            //    }),
            //    Name = "Jeden Tag um 7:00 -> Heizung 15 auf 14°C stellen"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(20, 30)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetLevel(99);
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetTemperature(22.0f);
            //    }),
            //    Name = "Jeden Tag um 20:30 -> Heizung 15 auf 22°C stellen"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(21, 30)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        await InteLukNetwork.Instance.Heatings.First(item => item.NodeID == 15).SetLevel(0);
            //    }),
            //    Name = "Jeden Tag um 21:30 -> Heizung 15 ganz aus machen"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(22, 40)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        try
            //        {
            //            await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetBrightness(255);
            //            await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetColor("#FFFF00");
            //        } catch { }
            //    }),
            //    Name = "DEBUG für Timer: 22:40 -> Licht gelb"
            //});
            //this._rules.Add(new Rule()
            //{
            //    Condition = new TimerCondition(TimerRecurrence.EveryDay(22, 43)),
            //    Action = new ActionRuleAction(async () =>
            //    {
            //        try
            //        {
            //            await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetColor("#FFFFFF");
            //            await InteLukNetwork.Instance.Lamps.First(item => item.NodeID == 3).SetBrightness(0);
            //        }
            //        catch { }
            //    }),
            //    Name = "DEBUG für Timer: 22:43 -> Licht weiss und aus"
            //});
            #endregion
        }
